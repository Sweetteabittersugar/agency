...
RISK_KEYWORDS = {
    "rm ": 8, "rm -rf": 10, "delete": 6, "DROP": 10, "DROP TABLE": 10,
    "format": 9, "mkfs": 10, "chmod 777": 7, "sudo": 8, "eval": 8,
    "exec(": 8, "subprocess": 5, "shell=True": 7, "--force": 6,
    "git push --force": 10, "git reset --hard": 7, "truncate": 6,
    "shutdown": 9, "reboot": 9, "> /dev/sda": 10, "dd if=": 10,
    "wget": 4, "curl": 4, "pip install": 4, "npm install -g": 5,
}
...
def calc_risk(tool_name: str, tool_input: dict) -> dict:
    ...
    # 基础风险：工具类型
    tool_risk = {
        "Bash": 4, "Write": 3, "Edit": 3, "TaskCreate": 2,
        "NotebookEdit": 2, "Agent": 3, "SendMessage": 2,
        "Read": 0, "Grep": 0, "Glob": 0, "WebSearch": 1, "WebFetch": 1,
    }
