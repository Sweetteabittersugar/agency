...
def record_cost(project_root, time_str, model, in_tokens, out_tokens, cost_usd, duration_s,
                agent="", project="", cache_read=0, cache_write=0, cache_saved=0.0,
                is_estimated=False, session_id=""):
