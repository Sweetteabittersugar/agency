...
ROUTING_KEYWORDS = {
    ...
    # [已删除] webnovel-writer — 2024-06-13 精简 Agent 系统
    "planner": [
        ("规划", 9),
        ("设计", 8),
        ("架构", 10),
    ...
    # [已删除] python-reviewer — 2024-06-13 精简 Agent 系统
    # [已删除] go-reviewer — 2024-06-13 精简 Agent 系统
    # [已删除] typescript-reviewer — 2024-06-13 精简 Agent 系统（语言专项审查统一由 code-reviewer 处理）
    "database-reviewer": [
        ("sql", 10),
        ("数据库", 10),
        ("mysql", 9),
    ...
    # [已删除] devops — 2024-06-13 精简 Agent 系统
    "doc-updater": [
        ("更新文档", 10),
        ("写文档", 10),
        ("文档更新", 10),
    ...
    # [已删除] build-error-resolver — 2024-06-13 精简 Agent 系统（构建错误由 debugger 处理）
    "e2e-runner": [
        ("e2e", 10),
        ("端到端", 10),
        ("浏览器测试", 9),
    ...
    # [已删除] ceo — 2024-06-13 精简 Agent 系统
    # [已删除] release-manager — 2024-06-13 精简 Agent 系统
    "lead": [
        ("委派", 10),
        ("领导", 9),
        ("异步", 8),
    ...
    # [已删除] verifier — 2024-06-13 精简 Agent 系统
    # [已删除] designer — 2024-06-13 精简 Agent 系统
    "test-generator": [
        ("生成测试", 10),
        ("写测试用例", 10),
        ("测试生成", 10),
    ...
    # [已删除] critic — 2024-06-13 精简 Agent 系统
    # [已删除] memory-keeper — 2024-06-13 精简 Agent 系统
    "router": [
        ("路由", 8),
        ("意图识别", 9),
        ("agent选择", 9),
